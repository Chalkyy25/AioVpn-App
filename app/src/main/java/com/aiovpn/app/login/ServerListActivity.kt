...
import com.aiovpn.app.home.AccountActivity
import com.aiovpn.app.home.HomeActivity
import com.aiovpn.app.home.SettingsActivity
...
class ServerListActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && serverId != null && serverLabel != null) {
            lifecycleScope.launch(Dispatchers.IO) {
                try {

    ...
    private void setStateInternal(final Tunnel tunnel, @Nullable final Config config, final State state)
        ...
        if (state == State.UP) {
            ...
            try {
                ...
                Log.d(TAG, "Excluding app from WireGuard tunnel: " + context.getPackageName());
            } catch (final android.content.pm.PackageManager.NameNotFoundException e) {
                Log.e(TAG, "Failed to exclude own package from WireGuard tunnel", e);
            }
            ...
            Log.d(TAG, "Using MTU from config: " + mtu);
            builder.setMtu(mtu);
